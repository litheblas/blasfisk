...
class MailingList(models.Model):
    ...
    members = models.ManyToManyField(User, through='Membership', null=True, blank=True, related_name="mailinglist_member_set") # Varför inte grupp? För att alla användare var och en ska kunna välja bort listor man inte vill vara med i även om någon admin/något skript tycker att de borde vara med.
