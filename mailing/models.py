...
class MailingList(models.Model):
    ...
    admins = models.ManyToManyField('blasbasen.User', null=True, blank=True, related_name="mailinglist_admin_set")
    members = models.ManyToManyField('blasbasen.User', through='Membership', null=True, blank=True, related_name="mailinglist_member_set") # Varför inte grupp? För att alla användare var och en ska kunna välja bort listor man inte vill vara med i även om någon admin/något skript tycker att de borde vara med.
