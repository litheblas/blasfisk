...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location._display_name'
        db.add_column(u'locations_location', '_display_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Location._display_name'
        db.delete_column(u'locations_location', '_display_name')
