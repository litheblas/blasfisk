...
class Location(AddressMixin, models.Model):
    ...
    latitude = models.DecimalField(max_digits=18, decimal_places=15, blank=True, null=True, verbose_name=_('latitude'))
    longitude = models.DecimalField(max_digits=18, decimal_places=15, blank=True, null=True, verbose_name=_('longitude'))
