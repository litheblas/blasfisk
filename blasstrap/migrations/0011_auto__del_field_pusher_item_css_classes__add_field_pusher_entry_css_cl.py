...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pusher.entry_css_classes'
        db.add_column(u'blasstrap_pusher', 'entry_css_classes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Pusher.entry_css_classes'
        db.delete_column(u'blasstrap_pusher', 'entry_css_classes')
