...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParallaxContent.image'
        db.add_column(u'blasstrap_parallaxcontent', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParallaxContent.image_placement'
        db.add_column(u'blasstrap_parallaxcontent', 'image_placement',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ParallaxContent.image'
        db.delete_column(u'blasstrap_parallaxcontent', 'image')

        # Deleting field 'ParallaxContent.image_placement'
        db.delete_column(u'blasstrap_parallaxcontent', 'image_placement')
    ...
    models = {
        ...
        u'blasstrap.parallaxcontent': {
            ...
            'image_placement': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
