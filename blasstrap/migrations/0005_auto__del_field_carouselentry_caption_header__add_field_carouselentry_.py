...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'CarouselEntry.caption_header'
        db.delete_column(u'blasstrap_carouselentry', 'caption_header')
    ...
    def backwards(self, orm):
        # Adding field 'CarouselEntry.caption_header'
        db.add_column(u'blasstrap_carouselentry', 'caption_header',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)
    ...
    models = {
        ...
        u'blasstrap.carouselentry': {
            ...
            'caption_heading': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
