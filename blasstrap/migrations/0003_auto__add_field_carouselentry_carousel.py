...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'CarouselEntry.carousel'
        db.add_column(u'blasstrap_carouselentry', 'carousel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='entries',
                                                                            to=orm['blasstrap.Carousel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CarouselEntry.carousel'
        db.delete_column(u'blasstrap_carouselentry', 'carousel_id')
