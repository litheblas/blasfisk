...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAddress.type'
        db.add_column(u'blasbase_personaddress', 'type',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonAddress.type'
        db.delete_column(u'blasbase_personaddress', 'type')
