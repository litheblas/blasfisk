...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assignment.function'
        db.alter_column(u'blasbase_assignment', 'function_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['blasbase.Function']))

    def backwards(self, orm):

        # Changing field 'Assignment.function'
        db.alter_column(u'blasbase_assignment', 'function_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blasbase.Function']))
