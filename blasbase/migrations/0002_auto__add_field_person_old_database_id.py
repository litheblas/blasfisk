...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.old_database_id'
        db.add_column(u'blasbase_person', 'old_database_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.old_database_id'
        db.delete_column(u'blasbase_person', 'old_database_id')
