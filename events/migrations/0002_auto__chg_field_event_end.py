...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.end'
        db.alter_column(u'events_event', 'end', self.gf('django.db.models.fields.DateTimeField')())
